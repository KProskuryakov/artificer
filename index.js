...
(function($PS) {
  ...
  var processEvent = function (g) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 67, column 1 - line 67, column 45): " + [ g.constructor.name, v.constructor.name ]);
      };
  };
  var newGame = {
      p: {
  ...
  var collide = function (p) {
      return function (l) {
          if (Data_Ord.between(Data_Ord.ordNumber)(l.x1)(l.x2)((centerOfMass(p)).cx) || Data_Ord.between(Data_Ord.ordNumber)(l.y1)(l.y2)((centerOfMass(p)).cy)) {
              var $22 = Data_Ord.between(Data_Ord.ordNumber)(p.y)(p.y + p.height)(l.y1);
              if ($22) {
                  return {
                      x: p.x,
                      y: l.y1 - p.height - 1.0,
          ...
          throw new Error("Failed pattern match at Main (line 104, column 1 - line 104, column 36): " + [ p.constructor.name, l.constructor.name ]);
      };
  };
  ...
  var main = function __do() {
      ...
      throw new Error("Failed pattern match at Main (line 30, column 3 - line 32, column 76): " + [ mCanvas.constructor.name ]);
  };
